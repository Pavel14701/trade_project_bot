...
class OrderBlockDetector:
    ...
    def zigzag_indicator(
        ...
        """
        Detects peaks and valleys in price data using ZigZag pattern analysis.

        Args:
            data (PriceDataFrame): Market price dataset containing high and low prices.
            config (OrderBlockDetectorDM): Configuration settings for peak detection.
