...
class SchemaInfer:
    ...
    def fit(
        ...
        Identifies numeric and categorical columns, builds vocabularies for categorical features,
        and stores the schema internally.
    ...
    def get_schema(self) -> Schema:
        ...
        Raises:
            RuntimeError: If schema has not been fitted.
        """
        if self._schema is None:
