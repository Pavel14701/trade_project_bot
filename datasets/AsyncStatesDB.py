...
class AsyncStateRequest:
    ...
    async def process_data_check_state_async(self, session:AsyncSession):
    ...
    async def check_state_async(self) -> dict:
        with AsyncSessionLocal() as session:
            return await self.process_data_check_state_async(session)


    @log_exceptions_async(logger)
    async def process_data_update_state_async(self, session:AsyncSession, new_state:dict) -> None:
    ...
    async def update_state_async(self, new_state:dict) -> None:
        with AsyncSessionLocal() as session:
            self.process_data_update_state_async(session, new_state)


    @log_exceptions_async(logger)
    async def process_data_save_position_state_async(self, session:AsyncSession, new_state:dict) -> None:
    ...
    async def save_position_state_async(self, new_state:dict) -> None:
        with AsyncSessionLocal() as session:
            await self.process_data_save_position_state_async(session, new_state)


    @log_exceptions_async(logger)
    async def process_data_save_none_state_async(self, session:AsyncSession):
